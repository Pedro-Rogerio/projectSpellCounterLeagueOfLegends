...
select1.addEventListener('change', function(){
    ...
    if((select1.value)=="9"){
        ...
        document.getElementById("ini1Top").setAttribute("onclick","startTimer(15, 'cronometro1Top');");
    }
});
...
select2.addEventListener('change', function(){
    ...
    if((select2.value)=="1"){
        ...
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(300, 'cronometro2Top');");
    }
    if((select2.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto2Top");
        alterarDisplay("cronometro2Top", "03", "30");
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(210, 'cronometro2Top');");
    }
    if((select2.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto2Top");
        alterarDisplay("cronometro2Top", "03", "00");
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(180, 'cronometro2Top');");
    }
    if((select2.value)=="4"){
    ...
    if((select2.value)=="6"){
        ...
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(240, 'cronometro2Top');");
    }
    if((select2.value)=="7"){
    ...
    if((select2.value)=="8"){
        ...
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(360, 'cronometro2Top');");
    }
    if((select2.value)=="9"){
        atualizarFoto("assets/smite.png", "foto2Top");
        alterarDisplay("cronometro2Top", "00", "15");
        document.getElementById("ini2Top").setAttribute("onclick","startTimer(150, 'cronometro2Top');");
    }
});
...
select3.addEventListener('change', function(){
    ...
    if((select3.value)=="1"){
        ...
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(300, 'cronometro1Jg');");
    }
    if((select3.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto1Jg");
        alterarDisplay("cronometro1Jg", "03", "30");
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(210, 'cronometro1Jg');");
    }
    if((select3.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto1Jg");
        alterarDisplay("cronometro1Jg", "03", "00");
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(180, 'cronometro1Jg');");
    }
    if((select3.value)=="4"){
    ...
    if((select3.value)=="6"){
        ...
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(240, 'cronometro1Jg');");
    }
    if((select3.value)=="7"){
    ...
    if((select3.value)=="8"){
        ...
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(360, 'cronometro1Jg');");
    }
    if((select3.value)=="9"){
        atualizarFoto("assets/smite.png", "foto1Jg");
        alterarDisplay("cronometro1Jg", "00", "15");
        document.getElementById("ini1Jg").setAttribute("onclick","startTimer(15, 'cronometro1Jg');");
    }
});
...
select4.addEventListener('change', function(){
    ...
    if((select4.value)=="1"){
        ...
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(300, 'cronometro2Jg');")
    }
    if((select4.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto2Jg");
        alterarDisplay("cronometro2Jg", "03", "30");
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(210, 'cronometro2Jg');")
    }
    if((select4.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto2Jg");
        alterarDisplay("cronometro2Jg", "03", "00");
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(180, 'cronometro2Jg');")
    }
    if((select4.value)=="4"){
    ...
    if((select4.value)=="6"){
        ...
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(240, 'cronometro2Jg');")
    }
    if((select4.value)=="7"){
    ...
    if((select4.value)=="8"){
        ...
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(360, 'cronometro2Jg');")
    }
    if((select4.value)=="9"){
        atualizarFoto("assets/smite.png", "foto2Jg");
        alterarDisplay("cronometro2Jg", "00", "15");
        document.getElementById("ini2Jg").setAttribute("onclick","startTimer(15, 'cronometro2Jg');")
    }
});
...
select5.addEventListener('change', function(){
    ...
    if((select5.value)=="1"){
        ...
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(300, 'cronometro1Mid');");
    }
    if((select5.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto1Mid");
        alterarDisplay("cronometro1Mid", "03", "30");
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(210, 'cronometro1Mid');");
    }
    if((select5.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto1Mid");
        alterarDisplay("cronometro1Mid", "03", "00");
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(180, 'cronometro1Mid');");
    }
    if((select5.value)=="4"){
    ...
    if((select5.value)=="6"){
        ...
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(240, 'cronometro1Mid');");
    }
    if((select5.value)=="7"){
    ...
    if((select5.value)=="8"){
        ...
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(360, 'cronometro1Mid');");
    }
    if((select5.value)=="9"){
        atualizarFoto("assets/smite.png", "foto1Mid");
        alterarDisplay("cronometro1Mid", "00", "15");
        document.getElementById("ini1Mid").setAttribute("onclick","startTimer(15, 'cronometro1Mid');");
    }
});
...
select6.addEventListener('change', function(){
    ...
    if((select6.value)=="1"){
        ...
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(300, 'cronometro2Mid');");
    }
    if((select6.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto2Mid");
        alterarDisplay("cronometro2Mid", "03", "30");
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(210, 'cronometro2Mid');");
    }
    if((select6.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto2Mid");
        alterarDisplay("cronometro2Mid", "03", "00");
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(180, 'cronometro2Mid');");
    }
    if((select6.value)=="4"){
    ...
    if((select6.value)=="6"){
        ...
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(240, 'cronometro2Mid');");
    }
    if((select6.value)=="7"){
    ...
    if((select6.value)=="8"){
        ...
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(360, 'cronometro2Mid');");
    }
    if((select6.value)=="9"){
        atualizarFoto("assets/smite.png", "foto2Mid");
        alterarDisplay("cronometro2Mid", "00", "15");
        document.getElementById("ini2Mid").setAttribute("onclick","startTimer(15, 'cronometro2Mid');");
    }
});
...
select7.addEventListener('change', function(){
    ...
    if((select7.value)=="1"){
        ...
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(300, 'cronometro1Adc');");
    }
    if((select7.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto1Adc");
        alterarDisplay("cronometro1Adc", "03", "30");
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(210, 'cronometro1Adc');");
    }
    if((select7.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto1Adc");
        alterarDisplay("cronometro1Adc", "03", "00");
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(180, 'cronometro1Adc');");
    }
    if((select7.value)=="4"){
    ...
    if((select7.value)=="6"){
        ...
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(240, 'cronometro1Adc');");
    }
    if((select7.value)=="7"){
    ...
    if((select7.value)=="8"){
        ...
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(360, 'cronometro1Adc');");
    }
    if((select7.value)=="9"){
        atualizarFoto("assets/smite.png", "foto1Adc");
        alterarDisplay("cronometro1Adc", "00", "00");
        document.getElementById("ini1Adc").setAttribute("onclick","startTimer(15, 'cronometro1Adc');");
    }
});
...
select8.addEventListener('change', function(){
    ...
    if((select8.value)=="1"){
        ...
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(300, 'cronometro2Adc');");
    }
    if((select8.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto2Adc");
        alterarDisplay("cronometro2Adc", "03", "30");
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(210, 'cronometro2Adc');");
    }
    if((select8.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto2Adc");
        alterarDisplay("cronometro2Adc", "03", "00");
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(180, 'cronometro2Adc');");
    }
    if((select8.value)=="4"){
    ...
    if((select8.value)=="6"){
        ...
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(240, 'cronometro2Adc');");
    }
    if((select8.value)=="7"){
    ...
    if((select8.value)=="8"){
        ...
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(360, 'cronometro2Adc');");
    }
    if((select8.value)=="9"){
        atualizarFoto("assets/smite.png", "foto2Adc");
        alterarDisplay("cronometro2Adc", "00", "15");
        document.getElementById("ini2Adc").setAttribute("onclick","startTimer(15, 'cronometro2Adc');");
    }
});
...
select9.addEventListener('change', function(){
    ...
    if((select9.value)=="1"){
        ...
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(300, 'cronometro1Sup');");
    }
    if((select9.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto1Sup");
        alterarDisplay("cronometro1Sup", "03", "30");
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(210, 'cronometro1Sup');");
    }
    if((select9.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto1Sup");
        alterarDisplay("cronometro1Sup", "03", "00");
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(180, 'cronometro1Sup');");
    }
    if((select9.value)=="4"){
    ...
    if((select9.value)=="6"){
        ...
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(240, 'cronometro1Sup');");
    }
    if((select9.value)=="7"){
    ...
    if((select9.value)=="8"){
        ...
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(360, 'cronometro1Sup');");
    }
    if((select9.value)=="9"){
        atualizarFoto("assets/smite.png", "foto1Sup");
        alterarDisplay("cronometro1Sup", "00", "15");
        document.getElementById("ini1Sup").setAttribute("onclick","startTimer(15, 'cronometro1Sup');");
    }
});
...
select10.addEventListener('change', function(){
    ...
    if((select10.value)=="1"){
        ...
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(300, 'cronometro2Sup');");
    }
    if((select10.value)=="2"){
        atualizarFoto("assets/purificar.png", "foto2Sup");
        alterarDisplay("cronometro2Sup", "03", "30");
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(210, 'cronometro2Sup');");
    }
    if((select10.value)=="3"){
        atualizarFoto("assets/exaustao.png","foto2Sup");
        alterarDisplay("cronometro2Sup", "03", "00");
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(180, 'cronometro2Sup');");
    }
    if((select10.value)=="4"){
    ...
    if((select10.value)=="6"){
        ...
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(240, 'cronometro2Sup');");
    }
    if((select10.value)=="7"){
    ...
    if((select10.value)=="8"){
        ...
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(360, 'cronometro2Sup');");
    }
    if((select10.value)=="9"){
        atualizarFoto("assets/smite.png", "foto2Sup");
        alterarDisplay("cronometro2Sup", "00", "15");
        document.getElementById("ini2Sup").setAttribute("onclick","startTimer(15, 'cronometro2Sup');");
    }
});
